...
public class UIFascilities: NSObject {
    ...
    public class func setAutoLayoutConstraints(subview: UIView?, superview: UIView?, margin: (top: CGFloat, right: CGFloat, bottom: CGFloat, left: CGFloat)) {
    ...
    public class func setAutoLayoutConstraints(subview: UIView?, superview: UIView?) {
    ...
    public enum UIFascilitiesLayoutStyle {
        case horizontal, vertical
        case noborder, bordered
    }
    
    public class func createActionsView(captions: Array<String>, backgroundColor: UIColor?, textColor: UIColor?, font: UIFont?, h_margin: CGFloat, v_margin: CGFloat, styles: Array<UIFascilitiesLayoutStyle>) -> (UIView?, Array<UIView>) {
