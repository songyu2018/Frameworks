...
public extension UIView {
    ...
    func showActivityIndicator(style: UIActivityIndicatorView.Style?, position: CGPoint?, andFreezeView freezeView: Bool) {
        ...
        var activityIndicator = self.viewWithTag(UIFascilities.activityIndicatorTag) as? UIActivityIndicatorView
        ...
        activityIndicator!.tag = UIFascilities.activityIndicatorTag
    ...
    func removeActivityIndicator(unfreezeView: Bool) {
        ...
        if let activityIndicator = self.viewWithTag(UIFascilities.activityIndicatorTag) as? UIActivityIndicatorView {
            activityIndicator.stopAnimating()
            activityIndicator.removeFromSuperview()
        }
        
        if let cancelImageView = self.viewWithTag(UIFascilities.activityIndicatorImageViewTag) as? UIImageView {
